...
<head>
    ...
    %>
    <!--
        不以/开始的相对路径,找资源,以当前资源的路径位为基准,经常容易
        出问题.
        以/开始的相对路径,找资源,以服务器的路径
        为标准(http://localhost:3306),需要加上项目名
    -->
    <!--引入jquery文件-->
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">empName
                        </label>
                        <div class="col-sm-10">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" name="gender"
                                       id="gender1_update_input" value="M" checked> 男
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="gender"
...
<script type="text/javascript">
    ...
    function build_emps_table(result){
        ...
        $.each(emps,function(i,n){
            var checkBoxTd=$("<td><input type='checkbox' class='check_n' /></td>");
            ...
            var departNameTd=$("<td></td>").append(n.department.deptName);
    ...
    function build_page_nav(result){
        ...
        var
            lastPageLi=$("<li></li>").append($("<a></a>").append("尾页").attr("href","#"));
    ...
    function getDepts(ele){
        //清空之前下拉列表的值
        //$("#empAddModal select").html("");
        $(ele).empty();
        $.ajax({
            url:"${APP_Path}/depts",
            type:"GET",
            success:function(result){
                //{"code":100,"msg":"处理成功!","extend":{"depts":[{"deptId":1,"deptName":"开发部"},{"deptId":3,"deptName":"开发部"},{"deptId":2,"deptName":"测试部"},{"deptId":4,"deptName":"测试部"}]}}
                //console.log(result);
                //显示部门信息在下拉列表中
    ...
    function validate_add_form(){
        ...
        var regName= /(^[A-Za-z0-9]{5,16}$)|(^[\u4e00-\u9fa5]{2,5}$)/;
            ...
            success:function(result){
                ...
                if(result.code==100){
                    ...
                    if(undefined!=result.extend.errorFields.empName){
                        //显示员工的错误信息
                        show_validate_msg("#empName_add_input","error",result.extend.errorFields.empName/*"邮箱不可用"*/);
                    }
                }
                //1.关闭模态框
    ...
    $("#check_all").click(function(){
        ...
        $(".check_n").prop("checked",$(this).prop("checked"));
    });

    //check_n
    $(document).on("click",".check_n",function(){
        //判断当前选择中的元素是否是5个
        var flag=$(".check_n:checked").length==$(".check_n").length;
